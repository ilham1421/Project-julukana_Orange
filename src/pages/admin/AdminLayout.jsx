...
import logoUrl from "../../data/logo_beaCukai.png";
...
const AdminLayout = ({ onAdminLogout, admin }) => {
  ...
  <img src={logoUrl} alt="Logo Bea Cukai" />;
  ...
  return (
    <div className="min-h-screen flex bg-slate-900 text-slate-100">
      ...
      <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
        ...
        <SheetContent
          side="left"
          className="bg-slate-800 p-0 border-r-slate-700 w-64 md:w-72"
        >
        ...
        <header className="bg-slate-800 shadow-md p-4 flex justify-between items-center md:justify-end">
          ...
          <div className="relative">
            <Button
              ...
              className="flex items-center space-x-2 text-slate-300 hover:text-amber-400"
            >
              <img
                src={`https://ui-avatars.com/api/?name=${adminFullName.charAt(
                  0
